...
public class InterpreterTest {
    ...
    public void testStartsWith() {
        assertEquals(true, eval("(starts-with '' '')"));
        assertEquals(true, eval("(starts-with 'apple' '')"));
        assertEquals(true, eval("(starts-with 'apple' 'ap')"));
        assertEquals(true, eval("(starts-with 'apple' 'app')"));
        assertEquals(true, eval("(starts-with 'apple' 'appl')"));
        assertEquals(true, eval("(starts-with 'apple' 'apple')"));
        assertEquals(false, eval("(starts-with 'apple' 'applex')"));
        assertEquals(false, eval("(starts-with '' 'a')"));
    }

    @Test
    public void testEndsWith() {
        assertEquals(true, eval("(ends-with '' '')"));
        assertEquals(true, eval("(ends-with 'apple' '')"));
        assertEquals(true, eval("(ends-with 'apple' 'e')"));
        assertEquals(true, eval("(ends-with 'apple' 'ple')"));
        assertEquals(true, eval("(ends-with 'apple' 'apple' )"));
        assertEquals(false, eval("(ends-with 'apple' 'xapple' )"));
        assertEquals(false, eval("(ends-with '' 'a')"));
    }
